  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="brand pull-left"> <a style="font-size:30px;color:#428bca;font-weight:bold;" href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>" ><img src="<?php echo get_template_directory_uri(); ?>/images/logo-tcb-2019-black.png" /></a></div>
		<nav class="navbar navbar-inverse">
          <div class="navbar-header">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse"> <span class="sr-only">Toggle navigation</span> <i class="mobMenu fl icon-menu1 blue-color ico20"></i></button>
            <!-- navbar-brand is hidden on larger screens, but visible when the menu is collapsed --> 
            <a class="navbar-brand" style="font-size:30px;color:#428bca;font-weight:bold;" href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logo-tcb-2019-black.png" /></a>
        ...
        <div id="hotline-new" class="hidden-xs"> 
...
<div class="page-title-container hidden-xs">
  <div class="container">
    ...
    if ( function_exists('yoast_breadcrumb') ) {
      yoast_breadcrumb( '<div id="breadcrumbs"><div class="breadcrumbs">','</div></div>' );
    } else {
      if (function_exists('rank_math_the_breadcrumbs')) rank_math_the_breadcrumbs('<div id="breadcrumbs"><div class="breadcrumbs">','</div></div>');
    }
    ?>
