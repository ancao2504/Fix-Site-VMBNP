...
function init_js_scripts(){
    ...
    if(is_page('chon-hanh-trinh')){
        ...
        wp_enqueue_script("result_flight",get_template_directory_uri()."/js/Flight_result.js",array(),'1.7.6',false);
...
function admin_load_scripts() {
    ...
    $current_admin_page = true;
    if(!$current_admin_page) {
...
Optimal Image 
*/
// add_filter( 'jpeg_quality', create_function( function() {return 80;} ) );
